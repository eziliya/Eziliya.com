...
import style from './JanaFinalReport.module.css'

export default function JanaFinalReport() {
  ...
  const AdditionalCost = formData.AdditionalCost || ''
  ...
  const ElectrificationElectricPolesObserved = formData.ElectrificationElectricPolesObserved || ''
  ...
  return (
     <div className={style.container}>
       <button onClick={handleDownloadPdf} className={style.downloadButton}>
         Download PDF
       </button>
       <div ref={reportRef}>
        <table>
            ...
            <tr> <th><h4>As per Documents/Plan : </h4></th>
              <td><input for='East' type="text" placeholder='East' id='East' className={style.input} /></td>
              <td> <input type="text" placeholder='West' className={style.input} /></td>
              <td><input type="text" placeholder='North' className={style.input} /></td>
              <td colSpan="2"><input type="text" placeholder='South' className={style.input} /></td></tr>
    
            <tr><td><h4>Actual at site :</h4></td>
              <td><input type="text" placeholder='East' className={style.input} /></td>
              <td><input type="text" placeholder='West' className={style.input} /></td>
              <td><input type="text" placeholder='North' className={style.input} /></td>
              <td colSpan="2"><input type="text" placeholder='South' className={style.input} /></td></tr>
            ...
            <tr>
              ...
              <td><input type="text" name='LegalAreaEast' id='LegalAreaEast' value={LegalAreaEast} placeholder='East' className={style.input} /></td>
              <td><input type="text" name='LegalAreaWest' id='LegalAreaWest' value={LegalAreaWest} placeholder='West' className={style.input} /></td>
              <td><input type="text" name='LegalAreaNorth' id='LegalAreaNorth' value={LegalAreaNorth} placeholder='North' className={style.input} /></td>
              <td><input type="text" name='LegalAreaSouth' id='LegalAreaSouth' value={LegalAreaSouth} placeholder='South' className={style.input} /></td>
              <td><input type="text" name='LegalTotalArea' id='LegalTotalArea' value={LegalTotalArea} placeholder='Total Area in Sqft' className={style.input} /></td>
            </tr>
    
    
            <tr> <td><h4>Actual Area at site in Sqft :</h4></td>
              <td><input type="text" name='ActualAreaEast' id='ActualAreaEast' value={ActualAreaEast} placeholder='East' className={style.input} /></td>
              <td><input type="text" name='ActualAreaWest' id='ActualAreaWest' value={ActualAreaWest} placeholder='West' className={style.input} /></td>
              <td><input type="text" name='ActualAreaNorth' id='ActualAreaNorth' value={ActualAreaNorth} placeholder='North' className={style.input} /></td>
              <td><input type="text" name='ActualAreaSouth' id='ActualAreaSouth' value={ActualAreaSouth} placeholder='South' className={style.input} /></td>
              <td><input type="text" name='ActualTotalArea' id='ActualTotalArea' value={ActualTotalArea} placeholder='Total Area in sqft' className={style.input} /></td>
            </tr>
            ...
            <tr>
              <td> <input type="text" name='Floor' id='Floor' value={Floor} placeholder='Ground Floor' className={style.input} /></td>
              <td> <input type="text" name='Accommodation' id='Accommodation' value={Accommodation} placeholder='Ground Floor Accommodation' className={style.input} /></td>
              <td> <input type="text" name='CarpetAreaSanctioned' id='CarpetAreaSanctioned'placeholder='Ground Floor Carpet Area in sq.ft.As per Sanctioned Plan' value={CarpetAreaSanctioned}  className={style.input} /></td>
              <td> <input type="text" name='CarpetAreaSite' id='CarpetAreaSite' placeholder='Ground Floor Carpet Area in sq.ft.As per Site Measurements' value={CarpetAreaSite} className={style.input} /></td>
              <td> <input type="text" name='PermissibleArea' id='PermissibleArea'placeholder='Ground Floor Permissible/plan Area in sq.ft.' value={PermissibleArea} className={style.input} /></td>
              <td> <input type="text" name='AdoptedArea' id='AdoptedArea' value={AdoptedArea} placeholder='Ground Floor Adopted Area in sq.ft.'className={style.input} /></td>
            </tr>
    
            <tr>
              <td><input type="text" name='Floor' id='Floor' value={Floor} placeholder='First Floor' className={style.input} /></td>
              <td><input type="text" name='Accommodation' id='Accommodation' value={Accommodation} placeholder='First Floor Accommodation' className={style.input} /></td>
              <td><input type="text" name='CarpetAreaSanctioned' id='CarpetAreaSanctioned' value={CarpetAreaSanctioned} placeholder='First Floor Carpet Area in sq.ft.As per Sanctioned Plan' className={style.input} /></td>
              <td><input type="text" name='CarpetAreaSite' id='CarpetAreaSite' value={CarpetAreaSite} placeholder='First Floor Carpet Area in sq.ft.As per Site Measurements' className={style.input} /></td>
              <td><input type="text" name='PermissibleArea' id='PermissibleArea' value={PermissibleArea} placeholder='First Floor Permissible/plan Area in sq.ft.' className={style.input} /></td>
              <td><input type="text" name='AdoptedArea' id='AdoptedArea' value={AdoptedArea} placeholder='First Floor Adopted Area in sq.ft' className={style.input} /></td>
            </tr>
    
            <tr>
              <td><input type="text" name='Floor' id='Floor' value={Floor} placeholder='Second Floor' className={style.input} /></td>
              <td><input type="text" name='Accommodation' id='Accommodation' value={Accommodation} placeholder='Second Floor Accommodation' className={style.input} /></td>
              <td><input type="text" name='CarpetAreaSanctioned' id='CarpetAreaSanctioned' value={CarpetAreaSanctioned} placeholder='Second Floor Carpet Area in sq.ft.As per Sanctioned Plan' className={style.input} /></td>
              <td><input type="text" name='CarpetAreaSite' id='CarpetAreaSite' value={CarpetAreaSite} placeholder='Second Floor Carpet Area in sq.ft.As per Site Measurements' className={style.input} /></td>
              <td><input type="text" name='PermissibleArea' id='PermissibleArea' value={PermissibleArea} placeholder='Second Floor Permissible/plan Area in sq.ft.' className={style.input} /></td>
              <td><input type="text" name='AdoptedArea' id='AdoptedArea' value={AdoptedArea} placeholder='Second Floor Adopted Area in sq.ft' className={style.input} /></td>
            </tr>
            <tr>
              <td><input type="text" name='Floor' id='Floor' value={Floor} placeholder='Third Floor' className={style.input} /></td>
              <td><input type="text" name='Accommodation' id='Accommodation' value={Accommodation} placeholder='Third Floor Accommodation' className={style.input} /></td>
              <td><input type="text" name='CarpetAreaSanctioned' id='CarpetAreaSanctioned' value={CarpetAreaSanctioned} placeholder='Third Floor Carpet Area in sq.ft.As per Sanctioned Plan' className={style.input} /></td>
              <td><input type="text" name='CarpetAreaSite' id='CarpetAreaSite' value={CarpetAreaSite} placeholder='Third Floor Carpet Area in sq.ft.As per Site Measurements' className={style.input} /></td>
              <td><input type="text" name='PermissibleArea' id='PermissibleArea' value={PermissibleArea} placeholder='Third Floor Permissible/plan Area in sq.ft.' className={style.input} /></td>
              <td><input type="text" name='AdoptedArea' id='AdoptedArea' value={AdoptedArea} placeholder='Third Floor Adopted Area in sq.ft' className={style.input} /></td>
            </tr>
    
            <tr>
              <td><input type="text" name='Floor' id='Floor' value={Floor} placeholder='Fourth Floor' className={style.input} /></td>
              <td><input type="text" name='Accommodation' id='Accommodation' value={Accommodation} placeholder='Fourth Floor' className={style.input} /></td>
              <td><input type="text" name='CarpetAreaSanctioned' id='CarpetAreaSanctioned' value={CarpetAreaSanctioned} placeholder='Fourth Floor Carpet Area in sq.ft.As per Sanctioned Plan' className={style.input} /></td>
              <td><input type="text" name='CarpetAreaSite' id='CarpetAreaSite' value={CarpetAreaSite} placeholder='Fourth Floor Carpet Area in sq.ft.As per Sanctioned Plan' className={style.input} /></td>
              <td><input type="text" name='PermissibleArea' id='PermissibleArea' value={PermissibleArea} placeholder='Fourth Floor Permissible/plan Area in sq.ft.' className={style.input} /></td>
              <td><input type="text" name='AdoptedArea' id='AdoptedArea' value={AdoptedArea} placeholder='Fourth Floor Adopted Area in sq.ft' className={style.input} /></td>
            </tr>
