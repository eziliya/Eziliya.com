...
import styles from './JanaForm.module.css'

export default function JanaForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/jana-report', { state: { formData: reportPayload } })
