...
import styles from './JalgaonBankFinalReport.module.css'
...
export default function JalgaonBankFinalReport() {
  ...
  const pdfFileName = useMemo(() => {
    ...
    return `JALGAON_BANK_TECHNICAL_VALUATION_${base}_${yyyy}${mm}${dd}.pdf`
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(element, {
        ...
        onclone: (doc) => {
          const cloned = doc.querySelector('[data-pdf-root="jalgaonbank"]')
          if (cloned) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div ref={reportRef} data-pdf-root="jalgaonbank">
        <table>
