...
import styles from './JalgaonBankForm.module.css'

export default function JalgaonBankForm() {
  ...
  const buildReportPayload = (data) => {
    ...
    // Map file field names to report field names
    const fileToReport = {
  ...
  const handleSubmit = async (e) => {
    ...
    navigate('/JalgaonBank-report', { state: { formData: reportPayload } })
