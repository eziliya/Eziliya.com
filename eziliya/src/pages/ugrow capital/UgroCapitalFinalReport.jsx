...
import styles from './UgroCapitalFinalReport.module.css'
import html2canvas from 'html2canvas'
import { jsPDF } from 'jspdf'

export default function UgroCapitalFinalReport() {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(element, {
        ...
        onclone: (doc) => {
          const cloned = doc.querySelector('[data-pdf-root="ugrocapital"]')
          if (cloned) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div ref={reportRef} data-pdf-root="ugrocapital">
        <table>
