...
import styles from './UgroCapitalForm.module.css';
import axios from 'axios';
import { useNavigate } from 'react-router-dom';

/** Serialize form values for React Router state; map file fields to filenames and align report keys. */
...
export default function UgroCapitalForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    navigate('/UgroCapital-report', { state: { formData: reportPayload } });
    setIsUploading(true);
    try {
