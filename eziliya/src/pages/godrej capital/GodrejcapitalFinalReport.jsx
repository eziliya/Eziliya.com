...
import styles from './GodrejcapitalFinalReport.module.css'
import html2canvas from 'html2canvas'
import { jsPDF } from 'jspdf'

export default function GodrejcapitalFinalReport() {
  ...
  const pdfFileName = useMemo(() => {
    ...
    return `GODREJ_CAPITAL_TECHNICAL_VALUATION_${base}_${yyyy}${mm}${dd}.pdf`
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(element, {
        ...
        onclone: (doc) => {
          const cloned = doc.querySelector('[data-pdf-root="godrejcapital"]')
          if (cloned) {
      ...
      if (!canvas.width || !canvas.height) {
        toast.error('Could not capture the report. Try scrolling to the top and try again.')
        return
      }
  ...
  return (
   <div className={styles.container}>
      ...
      <div ref={reportRef} data-pdf-root="godrejcapital">
        <table>
