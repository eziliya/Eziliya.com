...
import styles from './SvatantraHousingFinanceCorporationFinalReport.module.css'
import html2canvas from 'html2canvas'
import { jsPDF } from 'jspdf'

export default function SvatantraHousingFinanceCorporationFinalReport() {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(element, {
        ...
        onclone: (doc) => {
          const cloned = doc.querySelector('[data-pdf-root="svatantra"]')
          if (cloned) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div ref={reportRef} data-pdf-root="svatantra">
        <table>
