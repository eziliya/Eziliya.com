        ...
        >
          ...
          <table>
                ...
                <div style={{
                  ...
                  <div style={{
                   ...
                   <div style={{ textAlign: 'right', marginTop: '-40px' }}>
                    ...
                    />
                   <div style={{ textAlign: 'right',marginTop:'-1px', marginBottom: '10px' }}>
                    <h2 style={{
                      color: '#024606',
                      margin: '4px 0',
                      fontSize: '88px',
            ...
            <tr><th><label for='name'>Total Forced/Distressed Value at 100% completion(in Rs) :</label></th>
              ...
              <tr style={{height:240}} className={styles.noBorder} > <td></td></tr>
            ...
            <tr><th> <label for='name'>Realizable value(in Rs) :</label></th>
              ...
              <tr style={{height:300}} className={styles.noBorder} > <td></td></tr>
            ...
            <tr><td><name>Disclaimer :</name></td>
             ...
             <tr style={{height:800}} className={styles.noBorder} > <td></td></tr>
          ...
          <tr style={{height:250}} className={styles.noBorder} > <td></td></tr>
            ...
            <tr style={{height:880}} className={styles.noBorder} > <td></td></tr>
           ...
           <tr style={{height:900}} className={styles.noBorder} > <td></td></tr>
