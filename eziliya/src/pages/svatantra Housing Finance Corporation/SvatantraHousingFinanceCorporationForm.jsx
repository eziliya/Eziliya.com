...
import styles from './SvatantraHousingFinanceCorporationForm.module.css';
...
export default function SvatantraHousingFinanceCorporationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    navigate('/SvatantraHousingFinanceCorporation-report', { state: { formData: reportPayload } });
    setIsUploading(true);
    try {
