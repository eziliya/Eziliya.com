...
import styles from './LandTFinanceFinalReport.module.css'
import html2canvas from 'html2canvas'
import { jsPDF } from 'jspdf'

export default function LandTFinanceFinalReport() {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(element, {
        ...
        onclone: (doc) => {
          const cloned = doc.querySelector('[data-pdf-root="landt"]')
  ...
  return (
    <div className={styles.container}>
      ...
      <div ref={reportRef} data-pdf-root="landt" onChange={handleChange}>
        <table>
