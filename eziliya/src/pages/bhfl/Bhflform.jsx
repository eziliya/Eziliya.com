...
import styles from './Bhflform.module.css'

export default function Bhflform() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/Bhfl-report', { state: { formData: reportPayload } })
