...
import styles from './BhflFinalReport.module.css'
import html2canvas from 'html2canvas'
import { jsPDF } from 'jspdf'

export default function BhflFinalReport() {
  ...
  const pdfFileName = useMemo(() => {
    ...
    return `BHFL_TECHNICAL_VALUATION_${base}_${yyyy}${mm}${dd}.pdf`
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(element, {
        ...
        onclone: (doc) => {
          const cloned = doc.querySelector('[data-pdf-root="bhfl"]')
  ...
  return (
    <div className={styles.container}>
      ...
      <div ref={reportRef} data-pdf-root="bhfl">
        <div>
          <table>
