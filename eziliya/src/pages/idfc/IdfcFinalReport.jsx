...
import styles from './IdfcFinalReport.module.css'
import html2canvas from 'html2canvas'
import { jsPDF } from 'jspdf'

export default function IdfcFinalReport() {
  ...
  const pdfFileName = useMemo(() => {
    ...
    return `IDFC_TECHNICAL_VALUATION_${base}_${yyyy}${mm}${dd}.pdf`
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(element, {
        ...
        onclone: (doc) => {
          const cloned = doc.querySelector('[data-pdf-root="idfc"]')
          if (cloned) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div ref={reportRef} data-pdf-root="idfc">
        <table>
