...
import styles from './CapitalIndiaForm.module.css'

export default function CapitalIndiaform() {
  ...
  const handleSubmit = async (e) => {
    ...
    navigate('/CapitalIndia-report', { state: { formData: reportPayload } })
    setIsUploading(true)
    try {
