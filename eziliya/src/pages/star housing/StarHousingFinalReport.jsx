...
import styles from './StarHousingFinalReport.module.css'
import html2canvas from 'html2canvas'
import { jsPDF } from 'jspdf'

export default function StarHousingFinalReport() {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(element, {
        ...
        onclone: (doc) => {
          const cloned = doc.querySelector('[data-pdf-root="starhousing"]')
  ...
  return (
    <div className={styles.container}>
      ...
      <div ref={reportRef} data-pdf-root="starhousing" onChange={handleChange}>
        <table>
