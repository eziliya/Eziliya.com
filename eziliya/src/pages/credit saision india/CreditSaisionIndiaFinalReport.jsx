...
import styles from './CreditSaisionIndiaFinalReport.module.css'
import html2canvas from 'html2canvas'
import { jsPDF } from 'jspdf'

export default function CreditSaisionIndiaFinalReport() {
  ...
  const pdfFileName = useMemo(() => {
    ...
    return `CREDIT_SAISION_INDIA_TECHNICAL_VALUATION_${base}_${yyyy}${mm}${dd}.pdf`
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      const canvas = await html2canvas(element, {
        ...
        onclone: (doc) => {
          const cloned = doc.querySelector('[data-pdf-root="creditsaisionindia"]')
  ...
  return (
    <div className={styles.container}>
      ...
      <div ref={reportRef} data-pdf-root="creditsaisionindia">
        <div>
          <table>
