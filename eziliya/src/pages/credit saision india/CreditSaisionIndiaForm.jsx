...
import styles from './CreditSaisionIndiaForm.module.css'

export default function CreditSaisionIndiaForm() {
  ...
  const buildReportPayload = (data) => {
    ...
    // Map file fields to report field names
    const fileToReport = {
  ...
  const handleSubmit = async (e) => {
    ...
    navigate('/CreditSaisitionIndia-report', { state: { formData: reportPayload } })
    setIsUploading(true)
    try {
